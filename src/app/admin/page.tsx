...
import { FileText, DollarSign, Users, MessageSquare, TrendingUp, PenSquare, Mail, Send } from 'lucide-react';
...
export default async function AdminDashboardPage() {
  ...
  const [
    ...
    supabase.from('newsletter_sends').select('sent_count').eq('status', 'sent').order('created_at', { ascending: false }).limit(10),
  ]);
  ...
  const totalEmailsSent = (recentSends as { sent_count: number }[] | null)?.reduce((sum, s) => sum + s.sent_count, 0) ?? 0;

  const stats = [
    {
      label: 'Blog Posts',
      value: postsCount ?? 0,
      subtext: `${publishedPostsCount ?? 0} published`,
      icon: PenSquare,
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div className="grid md:grid-cols-4 gap-4">
          ...
          >
            ...
            <div>
              <p className="font-medium text-gray-800">New Post</p>
              <p className="text-sm text-gray-500">Create blog content</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              <p className="font-medium text-gray-800">Send Newsletter</p>
          ...
          >
            ...
            <div>
              <p className="font-medium text-gray-800">Research Digest</p>
              <p className="text-sm text-gray-500">New research summary</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              <p className="font-medium text-gray-800">Submissions</p>
