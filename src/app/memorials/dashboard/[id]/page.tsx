...
import MemorialOverview from '@/components/memorials/dashboard/MemorialOverview';

interface Props {
  params: Promise<{ id: string }>;
}

export default async function MemorialEditPage({ params }: Props) {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1 p-8">
        <MemorialOverview memorial={memorial} />
      </main>
    </div>
  );
}
